    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout>
        <Content style={{ padding: '20px', background: '#fff' }}>
          ...
          {selectedMenuKey === 'backtesting' && <div>Backtesting Component</div>}
          {selectedMenuKey === 'portfolio' && <div>Portfolio Management Component</div>}
          {selectedMenuKey === 'market-data' && <div>Market Data Component</div>}
          {selectedMenuKey === 'risk-analysis' && <div>Risk Analysis Component</div>}
