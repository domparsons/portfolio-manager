...
class Timeseries(Base):
    ...
    close = Column(Float, nullable=False)  # Set to False if close should always be available
    ...
    __table_args__ = (
        ...
        Index("ix_timeseries_asset_id", "asset_id"),  # Index on asset_id for faster lookups
        Index("ix_timeseries_timestamp", "timestamp"),  # Index on timestamp for range queries
    )
